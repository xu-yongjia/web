<!--
 * @Description: 全部商品页面组件(包括全部商品,商品分类)
 -->
<template>
  <div class="goods" id="goods" name="goods">
    <div class="breadcrumb">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item v-if="placeID">{{place}}</el-breadcrumb-item>
...
export default {
  ...
  created() {
    ...
    if(this.categoryID.length == 0){
      ...
      this.$axios
        .post(api, {
          placeID: parseInt(this.placeID),  //0的话请求全部，不等于零的话找特定食堂？ 先注释掉，以能显示图片
          categoryID: parseInt(this.categoryID[0]),  
  ...
  activated() {
    ...
    var index=parseInt(this.$route.query.placeID);
    this.place=this.placemap[index];  //显示地点信息
