          ...
          <div class="center-content">
            ...
            <div class="user-details">
              ...
              <div class="operate1">
                ...
                <p>
                  <router-link :to="{ path: '/order', query: {type:'未支付'} }" class="oper-href">查看待支付订单 ></router-link>
                </p>
              </div>
              <div class="operate">
              ...
              <div class="operate1">
                ...
                <p>
                  <router-link :to="{ path: '/order', query: {type:'所有已支付'} }" class="oper-href">查看已付款订单 ></router-link>
                </p>
              </div>
            </div>
            <div class="user-details1">
              ...
              <div class="operate1">
                <p class="oper-title">待评价商品：{{judge}}</p>
                <!-- <p>
                  <router-link to class="oper-href">查看待评价订单 ></router-link>
                </p> -->
                <p>
                  <router-link :to="{ path: '/order', query: {type:'已送达'} }" class="oper-href">查看待评价订单 ></router-link>
                </p>
              </div>
              <div class="operate">
              ...
              <div class="operate1">
                ...
                <p>
                  <router-link :to="{ path: '/collect'}" class="oper-href">查看收藏的商品 ></router-link>
                </p>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    getCount() {
        this.$axios
         .post("/api/users/showCount", {
          user_id:this.$store.getters.getUser.user_id
          })
          .then(res => {
          if (res.status === 200) {
            this.favoriteTotal = res.data.data.favorite_total
            this.notPayTotal = res.data.data.not_pay_total
            this.payTotal = res.data.data.pay_total
            this.judge=res.data.data.wait_judge
